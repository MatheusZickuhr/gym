...
class LunarLanderRandomFlag(gym.Env, EzPickle):
    metadata = {
...
class LunarLanderRandomFlagContinuous(LunarLanderRandomFlag):
    continuous = True
...
if __name__ == '__main__':
    demo_heuristic_lander(LunarLanderRandomFlag(), render=True)
